...
dimuons = cms.EDAnalyzer('UFDiMuonsAnalyzer',
                         ...
                         MuID_eff_3_file  = cms.string("Ntupliser/DiMuons/data/MuonIDIso/RunBCDEF_SF_ID.json"),
                         MuID_eff_4_file  = cms.string("Ntupliser/DiMuons/data/MuonIDIso/RunGH_SF_ID.json"),
                         MuIso_eff_3_file = cms.string("Ntupliser/DiMuons/data/MuonIDIso/RunBCDEF_SF_ISO.json"),
                         MuIso_eff_4_file = cms.string("Ntupliser/DiMuons/data/MuonIDIso/RunGH_SF_ID.json"),
